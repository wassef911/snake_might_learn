...
class StylerRenderer:
    ...
    def format(
        ...
        clean_hyperlinks: str | None = None,
    ) -> StylerRenderer:
        r"""
        ...
        clean_hyperlinks : {"html", "latex"}, optional
            Convert string patterns containing https://, http://, ftp:// or www. to
            HTML <a> tags as clickable URL clean_hyperlinks if "html", or LaTeX \href
            commands if "latex".
        ...
        for ci in cis:
            format_func = _maybe_wrap_formatter(
                ...
                thousands=thousands,
                escape=escape,
                clean_hyperlinks=clean_hyperlinks,
            )
            for ri in ris:
...
def _render_href(x, format):
    ...
    if isinstance(x, str):
        if format == "html":
            ...
            raise ValueError("``clean_hyperlinks`` format can only be 'html' or 'latex'")
...
def _maybe_wrap_formatter(
    ...
    # Render links
    if clean_hyperlinks is not None:
        func_3 = lambda x: func_2(_render_href(x, format=clean_hyperlinks))
    else:
        func_3 = func_2
